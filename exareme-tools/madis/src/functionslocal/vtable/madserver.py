"""
.. function:: madserver(host, port, db, query:None)
...
class MadServer(functions.vtable.vtbase.VT):
    ...
    def VTiter(self, *parsedArgs, **envars):
        ...
        try:
            ...
            # print description, json.loads(description)
...
def Source():
    return functions.vtable.vtbase.VTGenerator(MadServer)
