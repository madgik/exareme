...
class heatmapfinal:
    ...
    def final(self):
        import itertools
        yield tuple(itertools.chain.from_iterable((tuple(itertools.chain.from_iterable([("colname"+str(i), "id"+str(i), "minvalue"+str(i), "maxvalue" + str(i)) for i in xrange(self.nomydatacolumns)])),['num'])))
