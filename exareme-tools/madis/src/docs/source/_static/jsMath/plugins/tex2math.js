...
if (!jsMath.tex2math) {
    jsMath.tex2math = {}
}  // make sure jsMath.tex2math is defined
if (!jsMath.tex2math.loaded) {                // only load it once

    if (!jsMath.Controls) {
        jsMath.Controls = {}
    }
    if (!jsMath.Controls.cookie) {
    ...
    jsMath.Add(jsMath.tex2math, {
        ...
        CustomSearch: function (iOpen, iClose, dOpen, dClose) {
            this.inLineOpen = iOpen;
            this.inLineClose = iClose;
            this.displayOpen = dOpen;
            this.displayClose = dClose;
        ...
        EncloseMath: function (element) {
            ...
            if (!close) {
                close = jsMath.document.createTextNode("")
            }
            if (element == search.close) {
                element = close
            }
        ...
        createMathTag: function (type, text) {
            var tag = jsMath.document.createElement(type);
            tag.className = "math";
     ...
     *  Initialize
     */
    if (jsMath.Controls.cookie.tex2math == null) {
        jsMath.Controls.cookie.tex2math = 1
    }
    if (jsMath.tex2math.allowDisableTag == null) {
        jsMath.tex2math.allowDisableTag = 1
    }
