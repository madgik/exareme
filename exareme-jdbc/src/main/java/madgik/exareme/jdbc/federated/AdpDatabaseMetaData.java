...
public class AdpDatabaseMetaData implements java.sql.DatabaseMetaData {
    ...
    public ResultSet getTables(String catalog, String schemaPattern, String tableNamePattern,
        ...
        while (endpoints.hasNext()) {
            ...
            if (tableNamePattern.startsWith(dbID + "_")) {
                ...
                ResultSet first = cons.getConnection(nextEndpoint).getMetaData()
                    .getTables(catalog, schemaPatt, tableNamePattern, types);
        ...
        while (endpoints.hasNext()) {
            ...
            ResultSet next = cons.getConnection(nextEndpoint).getMetaData()
                .getTables(catalog, schemaPatt, tableNamePattern, types);
            while (next.next()) {
                sb.append("\n");
                ArrayList<Object> res = new ArrayList<Object>();
        ...
        return new AdpResultSet(new InputStreamReader(new StringBufferInputStream(sb.toString())),
            this.con.createStatement());
    }
    ...
    public ResultSet getColumns(String catalog, String schemaPattern, String tableNamePattern,
        ...
        while (endpoints.hasNext()) {
            ...
            if (tableNamePattern.startsWith(dbID + "_")) {
                ...
                ResultSet first = cons.getConnection(nextEndpoint).getMetaData()
                    .getColumns(catalog, schemaPatt, tableNamePattern, columnNamePattern);
    ...
    @Override public ResultSet getImportedKeys(String catalog, String schema, String table)
        ...
        ResultSet first = cons.getConnection(nextEndpoint).getMetaData()
            .getImportedKeys(catalog, schemaPatt, table);
    ...
    @Override public ResultSet getExportedKeys(String catalog, String schema, String table)
        ...
        ResultSet first = cons.getConnection(nextEndpoint).getMetaData()
            .getExportedKeys(catalog, schemaPatt, table);
    ...
    public ResultSet getIndexInfo(String catalog, String schema, String table, boolean unique,
        ...
        while (endpoints.hasNext()) {
            ...
            if (table.startsWith(dbID + "_")) {
                ...
                ResultSet first = cons.getConnection(nextEndpoint).getMetaData()
                    .getIndexInfo(catalog, schemaPatt, table, unique, approximate);
        ...
        throw new SQLException(dbID + " endpoint does not exist");
    }
