 ...
 */
package madgik.exareme.master.engine.client;
...
public class TpchDistributor {
    ...
    private static Logger log = Logger.getLogger(TpchDistributor.class);
    ...
    public static String createScript() throws RemoteException {
        ...
        for (int part = 0; part < 32; ++part) {
            script.append("operator op" + part + " c" + part +
                    "('madgik.exareme.db.operatorLibrary.tpch.TPCHFilePartReader', " + "part='" + part
                    + "', " + "memoryPercentage='60');\n");
