...
(function (H) {
        ...
        for (var af = 0; af < this._series.length; af++) {
            ...
            if (aj.show) {
                ...
                if (aj._type === "line" && aj.renderer.bands.show && this.name.charAt(0) !== "x") {
                    ag = [[0, aj.renderer.bands._min], [1, aj.renderer.bands._max]]
                }
                var ab = 1, ah = 1;
    ...
    function N() {
        ...
        this.noDataIndicator = {
            ...
            axes: {
                xaxis: {min: 0, max: 10, tickInterval: 2, show: true},
        ...
        this.parseOptions = function (aq) {
            ...
            if (H.isPlainObject(af.fillBetween)) {
                var ap = ["series1", "series2", "color", "baseSeries", "fill"], am;
            ...
            for (var al = 0; al < this.data.length; al++) {
                ...
                }, this.options.seriesDefaults, this.options.series[al], {rendererOptions: {animation: {show: this.animate}}});
                var ah = "vertical";
        ...
        this.draw = function () {
            if (this.drawIfHidden || this.target.is(":visible")) {
                ...
                var af = {top: 0, left: 0, bottom: 0, right: 0};
                ...
                for (var aB = 0, ay = H.jqplot.eventListenerHooks.length; aB < ay; aB++) {
                    this.eventCanvas._elem.bind(H.jqplot.eventListenerHooks[aB][0], {plot: this}, H.jqplot.eventListenerHooks[aB][1])
                }
                for (var aB = 0, ay = this.eventListenerHooks.hooks.length; aB < ay; aB++) {
                    this.eventCanvas._elem.bind(this.eventListenerHooks.hooks[aB][0], {plot: this}, this.eventListenerHooks.hooks[aB][1])
                }
        ...
        N.prototype.doFillBetweenLines = function () {
            ...
            var af = {fillStyle: ai, fill: true, closePath: true};
        ...
        function ac(ao) {
            ...
            var al = {x: ao.pageX - ai.left, y: ao.pageY - ai.top};
            var aj = {
                xaxis: null,
                yaxis: null,
                x2axis: null,
            ...
            return {offsets: ai, gridPos: al, dataPos: aj}
        }
            ...
            for (aN = ag.seriesStack.length - 1; aN >= 0; aN--) {
                ...
                switch (aI.renderer.constructor) {
                    ...
                    case H.jqplot.FunnelRenderer:
                        aD = af.x;
                        aC = af.y;
                        var aF = aI._vertices, aj = aF[0], ai = aF[aF.length - 1], am, ay, ar;
                        ...
                        switch (aw) {
                            case"xaxis":
                                ...
                                if (ah.showMark && ah.mark && ((!ah.isMinorTick && ab.drawMajorTickMarks) || (ah.isMinorTick && ab.drawMinorTickMarks))) {
                                    ...
                                    if (this.shadow) {
                                        this.renderer.shadowRenderer.draw(am, [[ae, at], [ae, ar]], {
                                            lineCap: "butt",
                            ...
                            case"yaxis":
                                ...
                                if (ah.showMark && ah.mark && ((!ah.isMinorTick && ab.drawMajorTickMarks) || (ah.isMinorTick && ab.drawMinorTickMarks))) {
                                    ...
                                    if (this.shadow) {
                                        this.renderer.shadowRenderer.draw(am, [[at, ae], [ar, ae]], {
                                            lineCap: "butt",
                                    ...
                                    ai(at, ae, ar, ae, {strokeStyle: ab.borderColor})
                                }
                                break;
                            case"x2axis":
                                if (ah.showGridline && this.drawGridlines && ((!ah.isMinorTick && ab.drawMajorGridlines) || (ah.isMinorTick && ab.drawMinorGridlines))) {
    ...
    H.jqplot.DivTitleRenderer.prototype.draw = function () {
        ...
        if (!this.text) {
            ...
            if (this.text) {
                ...
                var ac = {position: "absolute", top: "0px", left: "0px"};
                if (this._plotWidth) {
    ...
    H.jqplot.LinePattern = function (ap, ak) {
        ...
        return {moveTo: ao, lineTo: ad, beginPath: ac, closePath: ag}
    };
        ...
        if (aC.length) {
            if (aD) {
                if (au) {
                    ...
                    if (ab) {
                        var at = H.extend(true, {}, ak, {fill: false, closePath: false});
    ...
    function Z() {
        ...
        this.eventCanvas._elem.bind("mouseleave", {plot: this}, function (ab) {
            V(ab.data.plot)
        })
    }
    ...
    function X(ah, ag, ae, ad) {
        ...
        var af = {fillStyle: ac.highlightColor};
    ...
    H.jqplot.LinearAxisRenderer.prototype.set = function () {
        ...
        if (this.show) {
            ...
            if (this.name == "xaxis") {
                ai = ai + ah;
                this._elem.css({height: ai + "px", left: "0px", bottom: "0px"})
            } else {
                if (this.name == "x2axis") {
                    ai = ai + ah;
                    this._elem.css({height: ai + "px", left: "0px", top: "0px"})
                } else {
                    if (this.name == "yaxis") {
                        ai = ai + ac;
                        this._elem.css({width: ai + "px", left: "0px", top: "0px"});
                        if (ab && this._label.constructor == H.jqplot.AxisLabelRenderer) {
                            this._label._elem.css("width", ac + "px")
                        }
                    } else {
                        ai = ai + ac;
                        this._elem.css({width: ai + "px", right: "0px", top: "0px"});
                        if (ab && this._label.constructor == H.jqplot.AxisLabelRenderer) {
                            this._label._elem.css("width", ac + "px")
                        }
                    }
        ...
        if (aD.length) {
            ...
            if (this.min == null && this.max == null && this.tickInterval == null && !this.autoscale) {
                ...
                if (this.autoscale && this.min == null && this.max == null) {
                    ...
                    var aw = false;
                    var aG = false;
                    var au = {min: null, max: null, average: null, stddev: null};
    ...
    H.jqplot.MarkerRenderer.prototype.drawPlus = function (ae, ad, ah, ag, ak) {
        ...
        var ab = H.extend(true, {}, this.options, {closePath: false});
        if (this.shadow) {
            this.shadowRenderer.draw(ah, aj, {closePath: false});
            this.shadowRenderer.draw(ah, af, {closePath: false})
        }
    ...
    H.jqplot.TableLegendRenderer.prototype.addrow = function (ak, ae, ab, ai) {
        ...
        if (this.showSwatches) {
            ...
            ad.css({textAlign: "center", paddingTop: af});
            ...
            ag.css({backgroundColor: ae, borderColor: ae});
            ...
            if (this.placement == "insideGrid") {
                switch (this.location) {
                    ...
                    case"ne":
                        var ac = ad.right;
                        var ab = ad.top;
                        this._elem.css({right: ac, top: ab});
                        break;
                    case"e":
                        var ac = ad.right;
                    ...
                    case"se":
                        var ac = ad.right;
                        var ab = ad.bottom;
                        this._elem.css({right: ac, bottom: ab});
                        break;
                    case"s":
                        var ac = (ad.left + (this._plotDimensions.width - ad.right)) / 2 - this.getWidth() / 2;
                        var ab = ad.bottom;
                        this._elem.css({left: ac, bottom: ab});
                        break;
                    case"sw":
                        var ac = ad.left;
                        var ab = ad.bottom;
                ...
                if (this.placement == "outside") {
                    ...
                    switch (this.location) {
                        case"nw":
                            this._elem.css({left: 0, top: ad.top});
                            break;
                        case"n":
                            var ac = (ad.left + (this._plotDimensions.width - ad.right)) / 2 - this.getWidth() / 2;
                            this._elem.css({left: ac, top: ad.top});
                            break;
                        case"ne":
                            this._elem.css({right: 0, top: ad.top});
                            break;
                        case"e":
                            var ab = (ad.top + (this._plotDimensions.height - ad.bottom)) / 2 - this.getHeight() / 2;
                            this._elem.css({right: ad.right, top: ab});
                            break;
                        case"se":
                            this._elem.css({right: ad.right, bottom: ad.bottom});
                            break;
                        case"s":
                            var ac = (ad.left + (this._plotDimensions.width - ad.right)) / 2 - this.getWidth() / 2;
                            this._elem.css({left: ac, bottom: ad.bottom});
                            break;
                        case"sw":
                            this._elem.css({left: ad.left, bottom: ad.bottom});
                            break;
                        case"w":
                            var ab = (ad.top + (this._plotDimensions.height - ad.bottom)) / 2 - this.getHeight() / 2;
                            this._elem.css({left: ad.left, top: ab});
                            break;
                        default:
                            this._elem.css({right: ad.right, bottom: ad.bottom});
                            break
    ...
    H.jqplot.ThemeEngine.prototype.init = function () {
        var ae = new H.jqplot.Theme({_name: "Default"});
        var ah, ac, ag;
        for (ah in ae.target) {
            if (ah == "textColor") {
    ...
    H.jqplot.extend = function () {
        var ag = arguments[0] || {}, ae = 1, af = arguments.length, ab = false, ad;
    ...
    aa.config = {defaultLocale: "en", syntax: "perl", defaultCentury: 1900};
    ...
    aa.formats = {ISO: "%Y-%m-%dT%H:%M:%S.%N%G", SQL: "%Y-%m-%d %H:%M:%S"};
    aa.formats.perl = {
        codes: {
            matcher: /()%(#?(%|[a-z]))/i,
            Y: "FullYear",
    ...
    H.jqplot.sprintf = function () {
        ...
        return ag.replace(H.jqplot.sprintf.regex, function (aF, aq, ar, av, aH, aC, ao) {
            ...
            var aw = false, at = "", au = false, aE = false, ap = false, an = false;
    ...
    H.jqplot.getSignificantFigures = function (af) {
        ...
        return {significantDigits: ag, digitsLeft: ad, digitsRight: ae, zeros: ac, exponent: ab}
    };
...
$.extend($.jqplot.effects, {
    version: "1.9pre", save: function (b, c) {
        ...
        var c = {
            ...
            margin: 0,
            padding: 0
        }), a = {width: b.width(), height: b.height()}, d = document.activeElement;
        b.wrap(e);
        ...
        if (b.css("position") === "static") {
            ...
            $.extend(c, {position: b.css("position"), zIndex: b.css("z-index")});
...
$.jqplot.effects.effect.blind = function (c, h) {
    var d = $(this), k = ["position", "top", "bottom", "left", "right", "height", "width"], i = $.jqplot.effects.setMode(d, c.mode || "hide"), m = c.direction || "up", f = rvertical.test(m), e = f ? "height" : "width", j = f ? "top" : "left", p = rpositivemotion.test(m), g = {}, n = i === "show", b, a, l;
    ...
    b = $.jqplot.effects.createWrapper(d).css({overflow: "hidden"});
    a = f ? b[e]() + l : b[e]();
    g[e] = n ? String(a) : "0";
    if (!p) {
        d.css(f ? "bottom" : "right", 0).css(f ? "top" : "left", "").css({position: "absolute"});
        g[j] = n ? "0" : String(a)
    }
    if (n) {
        b.css(e, 0);
    ...
    b.animate(g, {
        duration: c.duration, easing: c.easing, queue: false, complete: function () {
            if (i === "hide") {
                d.hide()
            }
