...
public class HttpAsyncDecomposerHandler implements HttpAsyncRequestHandler<HttpRequest> {
    ...
    @Override public HttpAsyncRequestConsumer<HttpRequest> processRequest(final HttpRequest request,
        final HttpContext context) throws HttpException, IOException {
        return new BasicAsyncRequestConsumer();
    }

    @Override
    public void handle(final HttpRequest httpRequest, final HttpAsyncExchange httpExchange,
        final HttpContext context) throws HttpException, IOException {
        ...
        new Thread() {
            @Override public void run() {
                try {
                    if (query.startsWith("addFederatedEndpoint")) {
                        ...
                        ResultSet first =
                            c.getMetaData().getTables(params[1], params[2], params[3], null);
             ...
             * ArrayList<String> typenames=new ArrayList<String>();
                        ...
                        InputStreamEntity se = new InputStreamEntity(
                            new ByteArrayInputStream(sb.toString().getBytes()), -1,
                            ContentType.TEXT_PLAIN);
                        httpResponse.setEntity(se);
                        ...
                        ResultSet first =
                            c.getMetaData().getColumns(params[1], params[2], params[3], params[4]);
             ...
             * ArrayList<String> typenames=new ArrayList<String>();
                        ...
                        try {
                            ...
                            subqueries = d.getSubqueries2();
                            ArrayList<ArrayList<String>> schema =
                            ...
                            if (e.getMessage() == null) {
                                httpResponse.setEntity(new StringEntity("error explaining query",
                                    ContentType.TEXT_PLAIN));
                            } else {
                                httpResponse.setEntity(
                                    new StringEntity(e.getMessage(), ContentType.TEXT_PLAIN));
                            }
                        ...
                        // queries
                        InputStreamEntity se = new InputStreamEntity(create1ResultStream(), -1,
                            ContentType.TEXT_PLAIN);
                        ...
                        try {
                            ...
                            AdpDBClientProperties props =
                                new AdpDBClientProperties(dbname, "", "", false, false, false, -1,
                                    10, null);
                            AdpDBClient dbClient =
                                AdpDBClientFactory.createDBClient(manager, props);
                            ...
                            httpResponse.setEntity(
                                new InputStreamEntity(dbClient.readTable(resultTblName)));
                        } catch (Exception e) {
                            log.error(e);
                            httpResponse.setStatusCode(500);
                            if (e.getMessage() == null) {
                                httpResponse.setEntity(new StringEntity("error executing query",
                                    ContentType.TEXT_PLAIN));
                            } else {
                                httpResponse.setEntity(
                                    new StringEntity(e.getMessage(), ContentType.TEXT_PLAIN));
                    ...
                    httpResponse.setStatusCode(500);
                    httpResponse
                        .setEntity(new StringEntity(e.getMessage(), ContentType.TEXT_PLAIN));
                }
