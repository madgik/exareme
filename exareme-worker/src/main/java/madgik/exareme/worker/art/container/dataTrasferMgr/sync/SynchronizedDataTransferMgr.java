...
public class SynchronizedDataTransferMgr implements DataTransferMgrInterface {
    ...
    @Override public int addDataTransfer(AbstractOperatorImpl aoimpl, int ndts) {
        synchronized (dataTransferManagerDTP) {
    ...
    @Override public String getFileNamefromRegID(Integer regId) {
        synchronized (dataTransferManagerDTP) {
            return dataTransferManagerDTP.getFileNamefromRegID(regId);
        }
    }

    @Override public String getTableFilefromRegID(Integer regId) {
        synchronized (dataTransferManagerDTP) {
