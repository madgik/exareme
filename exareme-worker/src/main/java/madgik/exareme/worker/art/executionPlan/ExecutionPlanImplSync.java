...
public class ExecutionPlanImplSync implements EditableExecutionPlan {
    ...
    @Override public EntityName addContainer(Container c) throws SemanticError {
        synchronized (plan) {
    ...
    @Override public OperatorEntity addOperator(Operator operator) throws SemanticError {
        synchronized (plan) {
    ...
    @Override public StateEntity addState(State state) throws SemanticError {
        synchronized (plan) {
    ...
    @Override public StateLinkEntity addStateLink(StateLink statelink) throws SemanticError {
        synchronized (plan) {
            return plan.addStateLink(statelink);
        }
    }

    @Override public StateLinkEntity removeStateLink(String operatorName, String stateName)
    ...
    @Override public SwitchEntity addSwitch(Switch s) throws SemanticError {
        synchronized (plan) {
    ...
    @Override public PragmaEntity addPragma(Pragma p) throws SemanticError {
        synchronized (plan) {
    ...
    @Override public OperatorLinkEntity getOperatorLink(String from, String to)
        throws SemanticError {
        synchronized (plan) {
    ...
    @Override public OperatorLinkEntity addOperatorLink(OperatorLink opLink) throws SemanticError {
        synchronized (plan) {
            return plan.addOperatorLink(opLink);
        }
    }

    @Override public OperatorLinkEntity removeOperatorLink(String from, String to)
        throws SemanticError {
        synchronized (plan) {
