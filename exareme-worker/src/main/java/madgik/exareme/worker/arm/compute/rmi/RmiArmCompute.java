...
public class RmiArmCompute extends RmiRemoteObject<ArmComputeProxy> implements ArmCompute {
    ...
    @Override public ArmComputeProxy createProxy() throws RemoteException {
        super.register();
        return new RmiArmComputeProxy(super.getRegEntryName(), regEntityName);
    }

    @Override public ArmComputeSessionID createNewSession() throws RemoteException {
        synchronized (lock) {
            return new ArmComputeSessionID(sessionCount++);
        }
    }

    @Override public ComputeSessionContainerManagerProxy getComputeSessionContainerManagerProxy(
    ...
    @Override public ComputeSessionReportManagerProxy getComputeSessionReportManagerProxy(
        ArmComputeSessionID sessionID) throws RemoteException {
    ...
    @Override public ComputeSessionStatisticsManagerProxy getComputeSessionStatisticsManagerProxy(
        ArmComputeSessionID sessionID) throws RemoteException {
    ...
    @Override public ComputeSessionStatusManagerProxy getComputeSessionStatusManagerProxy(
        ArmComputeSessionID sessionID) throws RemoteException {
    ...
    @Override public synchronized void closeSession(ArmComputeSessionID sessionID)
    ...
    @Override public void stopArmCompute() throws RemoteException {
