 ...
 * @author herald
 */
public class AdpEmbeddedDatabaseMetaData implements java.sql.DatabaseMetaData {
    private AdpEmbeddedConnection con;
    private String dbUrl;

    public AdpEmbeddedDatabaseMetaData(AdpEmbeddedConnection connection, String url) {
        this.con = connection;
        this.dbUrl = url;
    }
