 ...
 * @author herald
 */
public class AdpEmbeddedResultSetMetaData implements ResultSetMetaData {
    private AdpEmbeddedResultSet resultSet;
    private ArrayList<String> typenames;
    private ArrayList<String> names;
    // private ArrayList<ArrayList<String>> metadata;

    public AdpEmbeddedResultSetMetaData(AdpEmbeddedResultSet adpResultSet,
