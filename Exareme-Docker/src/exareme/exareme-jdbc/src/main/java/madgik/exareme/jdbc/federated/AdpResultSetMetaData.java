...
public class AdpResultSetMetaData implements ResultSetMetaData {
    ...
    public AdpResultSetMetaData(AdpResultSet adpResultSet,
    ...
    public int getColumnType(int column) throws SQLException {
        ...
        if (typeName.equals("BIGINT") || typeName.equals("INT8") || typeName.equals(
                "UNSIGNED BIG INT")) {
        ...
        if (typeName.equals("INT") || typeName.equals("INTEGER") || typeName.equals(
                "MEDIUMINT")) {
        ...
        if (typeName.equals("CHARACTER") || typeName.equals("NCHAR")
                || typeName.equals("NATIVE CHARACTER")) {
