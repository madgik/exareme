 ...
 */
public class BufferLinkSerialiser implements JsonSerializer<BufferLink> {

    @Override
    public JsonElement serialize(BufferLink link, Type type, JsonSerializationContext jsc) {
