...
public class ManagerManagement implements ManagerManagementMBean {
    ...
    @Override
    public boolean isRegistryOnline() throws RemoteException {
        return artRegistryManager.isOnline();
    }

    @Override
    public String startRegistry() throws RemoteException {
        artRegistryManager.startArtRegistry();
        return "Registry online!";
    }

    @Override
    public String stopRegistry() throws RemoteException {
        artRegistryManager.stopArtRegistry();
        return "Registry offline!";
    }

    @Override
    public String connectToRegistry(String ip, int port) throws RemoteException {
    ...
    @Override
    public boolean isExecutionEngineOnline() throws RemoteException {
        return engineManager.isOnline();
    }

    @Override
    public String startExecutionEngine() throws RemoteException {
        engineManager.startExecutionEngine();
        return "Engine online!";
    }

    @Override
    public String stopExecutionEngine() throws RemoteException {
        engineManager.stopExecutionEngine();
        return "Engine offline!";
    }

    @Override
    public String connectToExecutionEngine() throws RemoteException {
        engineManager.connectToExecutionEngine();
        return "Connected to Execution Engine!";
    }

    @Override
    public String getExecutionEngineRegEntryName() throws RemoteException {
        return engineManager.getExecutionEngine().getRegEntryName();
    }

    @Override
    public boolean isContainerUp() throws RemoteException {
        return containerManager.isUp();
    }

    @Override
    public String startContainer() throws RemoteException {
        containerManager.startContainer();
        return "Contaner is up!";
    }

    @Override
    public String stopContainer() throws RemoteException {
        containerManager.stopContainer();
        return "Contaner is down!";
    }

    @Override
    public String getContainerRegEntryName() throws RemoteException {
