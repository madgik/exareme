...
public class Composer {
    ...
    private static String composeLocalAlgorithmsDFLScript(
        ...
        dflScript.append("distributed create table " + outputGlobalTbl + " as virtual \n");
    ...
    private static String composePipelineAlgorithmsDFLScript(
        ...
        dflScript.append(String.format("using output_local_tbl_%d distributed create table %s as virtual ",
    ...
    public static String composeIterativeAlgorithmsDFLScript(
        ...
        if (iterativeAlgorithmPhase.equals(termination_condition)) {
            ...
            dflScript.append(String.format("distributed create table %s as virtual \n", outputGlobalTbl));
            dflScript.append(
