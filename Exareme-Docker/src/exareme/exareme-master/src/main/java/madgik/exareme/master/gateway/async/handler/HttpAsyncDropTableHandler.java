 ...
 * @since 0.1
 */
public class HttpAsyncDropTableHandler implements HttpAsyncRequestHandler<HttpRequest> {
    private static final Logger log = Logger.getLogger(HttpAsyncDropTableHandler.class);
    ...
    private void handleInternal(HttpRequest request, HttpResponse response, HttpContext context)
        ...
        try {
            ...
            query = " distributed drop table " + table + ";";
