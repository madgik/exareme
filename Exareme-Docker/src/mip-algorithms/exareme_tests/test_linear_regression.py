...
def check_privacy_result(result):
    assert result == assert result == "{\"result\" : [{\"data\":\" Incorrect parameter value. encodingparameter'value should be one of the following: dummycoding,sumscoding,simplecoding \",\"type\":\"text/plain+user_error\"}]}"
