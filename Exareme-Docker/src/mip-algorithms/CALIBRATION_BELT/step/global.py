...
def cb_global_iter(global_state, global_in):
    ...
    # Unpack global input
    ll_new_dict, grad_dict, hess_dict = global_in.get_data()
    ...
    for deg in range(1, max_deg + 1):
        ...
        delta_dict[deg] = abs(ll_new_dict[deg] - ll_old_dict[deg])
    iter += 1

    # Pack state and results
    global_state = StateData(n_obs=n_obs, ll_old_dict=ll_old_dict, ll_new_dict=ll_new_dict, coeff_dict=coeff_dict,
