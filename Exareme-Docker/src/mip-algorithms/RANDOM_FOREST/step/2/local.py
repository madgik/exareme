...
from RF_lib import RF_Glob2Loc_TD, RFIter2_Loc2Glob_TD, RF_step_2_local
...
def main():
    ...
    rF_activePaths = RF_step_2_local(local_state['args_Y'], local_state['args_n_trees'], local_state['rF_dataFrame'], local_state['rF_DataSchema'], local_state['rF_categoricalVariables'], rF_activePaths, rF_Logs)
    ...
    local_out = RFIter2_Loc2Glob_TD(rF_activePaths)
    local_out.transfer()
