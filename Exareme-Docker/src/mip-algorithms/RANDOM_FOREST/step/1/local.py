...
from RF_lib import RF_Glob2Loc_TD, RFIter1_Loc2Glob_TD, RF_step_1_local
...
def main():
    ...
    init_logger()
    logging.warning("Step1Local: rF_globalTree, rF_activePaths")
    logging.warning([rF_globalTree, rF_activePaths])

    #2. Run algorithm local iteration step
    rF_activePaths = RF_step_1_local( local_state['args_Y'], local_state['args_n_trees'], local_state['rF_dataFrame'], local_state['rF_DataSchema'], local_state['rF_categoricalVariables'], rF_activePaths, rF_Logs)
    ...
    local_out = RFIter1_Loc2Glob_TD(rF_activePaths)
    local_out.transfer()
