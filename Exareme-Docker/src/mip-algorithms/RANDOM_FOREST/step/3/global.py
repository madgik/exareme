...
from RF_lib import RFIter3_Loc2Glob_TD, RF_Glob2Loc_TD, RF_step_3_global
...
def main():
    ...
    rF_activePaths = RFIter3_Loc2Glob_TD.load(path.abspath(args.local_step_dbs)).get_data()

    #2. Run algorithm: -->pass
    rF_globalTree, rF_activePaths, rF_Logs = RF_step_3_global(  global_state['args_Y'], global_state['args_n_trees'],
                                                                global_state['rF_DataSchema'], global_state['rF_categoricalVariables'],
                                                                rF_activePaths, global_state['rF_globalTree'],
                                                                global_state['rF_Logs'],
                                                                global_state['stepsNo'],global_state['args_max_depth'] )
