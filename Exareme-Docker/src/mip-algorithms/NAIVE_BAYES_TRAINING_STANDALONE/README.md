<b><h2><center>Naive Bayes Training</center></h1></b>
...
In Naive Bayes algorithm the attributes of *X* can be both categorical and continuous, while the *y* is always categorical. The training procedure is different for the categorical and continuous cases.
