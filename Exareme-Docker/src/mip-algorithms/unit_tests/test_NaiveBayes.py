...
url1='http://88.197.53.23:9090/mining/query/CROSS_VALIDATION_K_FOLD'
url2='http://88.197.53.23:9090/mining/query/NAIVE_BAYES_TRAINING'
url3='http://88.197.53.23:9090/mining/query/NAIVE_BAYES_TESTING'
...
# 0.26475694 0.05989583 0.61892361 0.05642361
    ...
    for result1 in trainingResult['results']:
